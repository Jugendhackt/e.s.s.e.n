...
$apple = new FoodItem("Q2")

?>
<h1><?php echo $apple->name ?></h1>
<ul>
    <li>Energy: <?php echo($apple->getProperty("P2")->valueString()); ?>
    </li>
</ul>
